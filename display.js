...
//     console.log(
//       `The path from (${xStart},${yStart}) to (${xEnd},${yEnd}) was completed in ${
//         path.length - 1
//       } moves`
//     );
//     guiDisplay.textContent = `The path from (${xStart},${yStart}) to (${xEnd},${yEnd}) was completed in ${
//       path.length - 1
//     } moves: \r\n`;
//     let moveCount = 0;
